...
The simulation we developed incrementally across ten versions, beginning with random exploration and gradually introducing resource collection, robot states, pheromone communication, robot failures, sensor noise, and performance metrics.
